...
async def start(client, message):
    ...
    if len(message.command) != 2 or (len(message.command) == 2 and message.command[1] == "start"):
	    ...
	    InlineKeyboardButton('• sᴜᴘᴘᴏʀᴛ •', url=f"https://t.me/YandereMommyDLGen_bot")
 	    ...
 	    InlineKeyboardButton('♻️ ᴅᴇᴠᴇʟᴏᴘᴇʀ ♻️', url=f"https://t.me/YandereMommyDLGen_bot")
        ]]
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        buttons = [[
	    InlineKeyboardButton('💻 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ', url='https://t.me/YandereMommyDLGen_bot')
	],[
...
# For Any Kind Of Error Ask Us In Support Group @AV_SUPPORT_GROUP
        ...
        if len(str(user_id)) == 10:
            ...
            try:
                await client.send_message(user_id , f"<b>ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ʙʏ [YABDERE MOMMY](https://t.me/YandereMommyDLGen_bot)\nʀᴇᴀsᴏɴ : {reason}</b>")
        ...
        if len(str(user_id)) == 10:
            try:
                unban_text = "<b>ʜᴜʀʀᴀʏ..ʏᴏᴜ ᴀʀᴇ ᴜɴʙᴀɴɴᴇᴅ ʙʏ [YANDERE MOMMY](https://t.me/YandereMommyDLGen_bot)</b>"
